...
class VirtualObjectInteraction: NSObject, UIGestureRecognizerDelegate {
    ...
    init(sceneView: VirtualObjectARView) {
        ...
        [UISwipeGestureRecognizerDirection.down, UISwipeGestureRecognizerDirection.up, UISwipeGestureRecognizerDirection.left, UISwipeGestureRecognizerDirection.right].forEach { addSwipeGesture(for: $0) }
...
//        sceneView.addGestureRecognizer(panGesture)
    ...
    func addSwipeGesture(for direction: UISwipeGestureRecognizerDirection) {
        let swipeGesture = UISwipeGestureRecognizer(target: self, action: #selector(throwObject(_:)))
